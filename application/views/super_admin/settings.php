...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pengaturan Akun Super Admin</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url(); ?>Settings/lengkapi_data_superadmin" method="POST">
                                    <input type="hidden" name="id_user" value="<?= $superadmin['id_user'] ?>">
                                    <input type="hidden" name="id_user_detail"
                                        value="<?= $superadmin['id_user_detail'] ?>">

                                    <!-- Username (NIP/NRP) dengan keterangan -->
                                    <div class="form-group">
                                        <label for="username">Username (NIP/NRP)</label>
                                        <input type="text" class="form-control" name="username"
                                            value="<?= $superadmin['username'] ?>" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_lengkap"
                                                    value="<?= $superadmin['nama_lengkap'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <!-- Field Email -->
                                                ...
                                                <select class="form-control" name="pangkat">
                                                    ...
                                                    <optgroup label="Golongan IV (Pembina)">
                                                        <option value="Pembina Utama (IV/e)"
                                                            <?= $superadmin['pangkat'] == 'Pembina Utama (IV/e)' ? 'selected' : '' ?>>Pembina Utama (IV/e)</option>
                                                        <option value="Pembina Utama Madya (IV/d)"
                                                            <?= $superadmin['pangkat'] == 'Pembina Utama Madya (IV/d)' ? 'selected' : '' ?>>Pembina Utama Madya (IV/d)</option>
                                                        <option value="Pembina Utama Muda (IV/c)"
                                                            <?= $superadmin['pangkat'] == 'Pembina Utama Muda (IV/c)' ? 'selected' : '' ?>>Pembina Utama Muda (IV/c)</option>
                                                        <option value="Pembina Tingkat I (IV/b)"
                                                            <?= $superadmin['pangkat'] == 'Pembina Tingkat I (IV/b)' ? 'selected' : '' ?>>Pembina Tingkat I (IV/b)</option>
                                                        <option value="Pembina (IV/a)"
                                                            <?= $superadmin['pangkat'] == 'Pembina (IV/a)' ? 'selected' : '' ?>>Pembina (IV/a)</option>
                                                    </optgroup>
                                                    <optgroup label="Golongan III (Penata)">
                                                        <option value="Penata Tingkat I (III/d)"
                                                            <?= $superadmin['pangkat'] == 'Penata Tingkat I (III/d)' ? 'selected' : '' ?>>Penata Tingkat I (III/d)</option>
                                                        <option value="Penata (III/c)"
                                                            <?= $superadmin['pangkat'] == 'Penata (III/c)' ? 'selected' : '' ?>>Penata (III/c)</option>
                                                        <option value="Penata Muda Tingkat I (III/b)"
                                                            <?= $superadmin['pangkat'] == 'Penata Muda Tingkat I (III/b)' ? 'selected' : '' ?>>Penata Muda Tingkat I (III/b)</option>
                                                        <option value="Penata Muda (III/a)"
                                                            <?= $superadmin['pangkat'] == 'Penata Muda (III/a)' ? 'selected' : '' ?>>Penata Muda (III/a)</option>
                                                    </optgroup>
                                                    <optgroup label="TNI - Perwira Tinggi">
                                                        <option value="Jenderal" <?= $superadmin['pangkat'] == 'Jenderal' ? 'selected' : '' ?>>Jenderal</option>
                                                        <option value="Letnan Jenderal"
                                                            <?= $superadmin['pangkat'] == 'Letnan Jenderal' ? 'selected' : '' ?>>Letnan Jenderal</option>
                                                        <option value="Mayor Jenderal" <?= $superadmin['pangkat'] == 'Mayor Jenderal' ? 'selected' : '' ?>>Mayor Jenderal</option>
                                                        <option value="Brigadir Jenderal"
                                                            <?= $superadmin['pangkat'] == 'Brigadir Jenderal' ? 'selected' : '' ?>>Brigadir Jenderal</option>
                                                    </optgroup>
                                                    <option value="Lainnya" <?= $superadmin['pangkat'] == 'Lainnya' ? 'selected' : '' ?>>Lainnya</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="jabatan"
                                                    value="<?= $superadmin['jabatan'] ?>" required
                                                    placeholder="Masukkan Jabatan">
                                                <small class="text-muted">Contoh: Staf Administrasi, Analis Kebijakan,
                                                    dll.</small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="id_jenis_kelamin" required>
                                                    <?php foreach ($jenis_kelamin as $jk): ?>
                                                        <option value="<?= $jk["id_jenis_kelamin"] ?>"
                                                            <?= $jk["id_jenis_kelamin"] == $superadmin['id_jenis_kelamin'] ? 'selected' : '' ?>>
                                                            <?= $jk["jenis_kelamin"] ?>
                                                        </option>
                                                    <?php endforeach ?>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="alamat"
                                                    rows="1"><?= $superadmin['alamat'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url(); ?>Settings/settings_account_superadmin" method="POST"
                                    id="passwordForm">

                                    <!-- [BARU] Hidden input untuk username -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const username = '<?= $username ?>'; // Ambil username dari controller
