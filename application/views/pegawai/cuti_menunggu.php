        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    Daftar Cuti Menunggu Persetujuan
                </h3>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="cutiMenungguTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php if (!empty($cuti_menunggu) && is_array($cuti_menunggu)): ?>
                                <?php $no = 1;
                                foreach ($cuti_menunggu as $c): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            switch ($c['id_status_cuti']) {
                                                ...
                                                case 4:
                                                    ...
                                                    $status_class = 'info';
                                                    $status_icon = 'fas fa-user-shield';
                                                    break;
                                                default:
                                            ...
                                            <br><small
                                                class="text-muted"><?= date('d/m/Y', strtotime($c['tgl_diajukan'])) ?></small>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <!-- Tombol Edit hanya untuk status menunggu atasan -->
                                                <?php if ($c['id_status_cuti'] == 1): ?>
                                                    <a href="<?= base_url('Cuti/edit_cuti_pegawai/' . $c['id_cuti']) ?>"
                                                        class="btn btn-sm btn-warning" title="Edit Pengajuan">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <!-- Tombol Hapus hanya untuk status menunggu atasan -->
                                                <?php if ($c['id_status_cuti'] == 1): ?>
                                                    <button class="btn btn-sm btn-danger" data-toggle="modal"
                                                        data-target="#hapus_<?= $c['id_cuti'] ?>" title="Batalkan Pengajuan">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <small class="text-success">(<?= $c['jumlah_hari'] ?? 0 ?>
                                                                hari)</small><br><br>

                                                            <strong>Status:</strong><br>
                                                            <?php if ($c['id_status_cuti'] == 1): ?>
                                                                <span class="badge badge-warning">Menunggu Persetujuan Atasan</span>
                                    ...
                                    <div class="modal fade" id="hapus_<?= $c['id_cuti'] ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Batalkan Pengajuan Cuti</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="<?= base_url('Cuti/hapus_cuti_menunggu') ?>" method="POST"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center py-4">
                                        ...
                                        <br><span class="text-muted">Tidak ada cuti yang menunggu persetujuan</span>
                                        <br>
