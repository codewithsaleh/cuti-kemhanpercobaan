...
|--------------------------------------------------------------------------
|
| [SOLUSI CERDAS] URL dasar ini sekarang akan diatur secara otomatis.
| Anda tidak perlu mengubahnya lagi saat berganti jaringan atau menggunakan ngrok.
|
*/
// Menentukan protokol (http atau https)
$protocol = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? "https" : "http";

// Mendapatkan nama host (localhost, 192.168.x.x, atau alamat ngrok)
$host = $_SERVER['HTTP_HOST'];

// Menentukan path ke folder proyek Anda
$path = str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);

// Menggabungkan semuanya menjadi satu URL yang dinamis
$config['base_url'] = $protocol . '://' . $host . $path;
$config['base_url'] = 'http://localhost/cuti-kemhanpercobaan/';
...
*/
// [MODIFIKASI FINAL] Memberikan path yang benar ke autoloader
...
// Set error reporting
ini_set('display_errors', 0); // Off di production
...
// TAMBAH INI - Set timezone ke Asia/Jakarta (WIB)
