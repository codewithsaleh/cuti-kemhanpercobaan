...
class Dashboard extends CI_Controller {
    ...
    public function dashboard_pegawai() {
        ...
        $data['cuti'] = ['total' => $stats['total_pengajuan'] ?? 0];
        $data['cuti_acc'] = ['total' => $stats['diterima'] ?? 0];
        $data['cuti_confirm'] = ['total' => $stats['menunggu_konfirmasi'] ?? 0];
        $data['cuti_reject'] = ['total' => $stats['ditolak'] ?? 0];
