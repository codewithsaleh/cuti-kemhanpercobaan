    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= base_url();?>Cuti/view_pegawai/<?=$this->session->userdata('id_user');?>" class="nav-link <?php if($this->uri->segment(1) == 'Cuti'){ echo 'active';} ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url();?>Pesan/view_pegawai" class="nav-link <?php if($this->uri->segment(1) == 'Pesan'){ echo 'active';} ?>">
