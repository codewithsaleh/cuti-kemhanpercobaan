                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <p class="mb-1"><strong>Nama:</strong> <?= htmlspecialchars($user['nama_lengkap'] ?? 'N/A') ?></p>
                                        <p class="mb-1"><strong>NIP:</strong> <?= htmlspecialchars($user['nip'] ?? 'N/A') ?></p>
                                        <p class="mb-0"><strong>Sisa Cuti:</strong> <span class="badge badge-success"><?= $user['sisa_cuti'] ?? 12 ?> hari</span></p>
                                    </div>
