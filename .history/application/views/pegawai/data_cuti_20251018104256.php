                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="<?= base_url('Form_Cuti/add_cuti') ?>" class="btn btn-primary btn-sm">
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="8" class="text-center py-4">
                                                    ...
                                                    <br><a href="<?= base_url('Form_Cuti/add_cuti') ?>" class="btn btn-primary btn-sm mt-2">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br><small class="text-muted">(<?= ($c['jumlah_hari'] ?? round((strtotime($c['berakhir']) - strtotime($c['mulai'])) / (60 * 60 * 24) + 1)) ?> hari)</small>
                                        </td>
                                    </tr>
                                    <tr>
