                            ...
                            <div class="row no-gutters chat-container">
                                ...
                                <div class="col-md-4 contact-list">
                                    <div class="p-3 border-bottom">
                                        ...
                                        <small class="text-muted">Hubungi admin untuk bantuan terkait cuti</small>
                                    </div>
                                        ...
                                        <div class="contact-item <?= ($selected_user && $selected_user['id_user'] == $contact['id_user']) ? 'active' : '' ?>" 
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar mr-3">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="bg-<?= $contact['user_level'] == 'super admin' ? 'danger' : 'primary' ?> rounded-circle d-flex align-items-center justify-content-center" 
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <br><small class="badge badge-<?= $contact['user_level'] == 'super admin' ? 'danger' : 'primary' ?> badge-sm">
                                                        <?= ucwords($contact['user_level']) ?>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <div class="p-3 text-center text-muted">
                                            ...
                                            <p>Tidak ada admin tersedia saat ini</p>
                                            <small>Silakan hubungi administrator sistem</small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <div class="no-chat-selected">
                                            <div class="text-center">
                                                ...
                                                <div class="alert alert-info mt-3">
                                                    ...
                                                    <strong>Tips:</strong> Anda dapat menanyakan tentang:
                                                    <ul class="mb-0 mt-2">
                                                        <li>Status pengajuan cuti</li>
                                                        <li>Prosedur pengajuan cuti</li>
                                                        <li>Sisa jatah cuti</li>
                                                        <li>Bantuan teknis sistem</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
