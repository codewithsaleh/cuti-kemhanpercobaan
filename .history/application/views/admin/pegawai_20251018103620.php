                    ...
                    <div class="modal-body">
                        <form action="<?=base_url();?>Pegawai/tambah_pegawai" method="POST">
                            <div class="alert alert-info">
                                ...
                                <strong>Informasi:</strong> Akun akan dibuat dengan <strong>NIP/NRP sebagai Username</strong> dan password default <strong>'kemhan2025'</strong>.
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_atasan">
                                    ...
                                    <?php if (!empty($atasan_list)): ?>
                                        <?php foreach($atasan_list as $atasan): ?>
                                        <option value="<?= htmlspecialchars($atasan['id_user']) ?>">
                                            <?= htmlspecialchars($atasan['nama_lengkap']) ?> - <?= htmlspecialchars($atasan['jabatan']) ?> (<?= ucfirst($atasan['user_level']) ?>)
                                        </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            ...
                            <div class="alert alert-warning">
                                <h6><i class="fas fa-key"></i> Informasi Akun:</h6>
                                <p class="mb-1"><strong>Username:</strong> [Sama dengan NIP/NRP]</p>
