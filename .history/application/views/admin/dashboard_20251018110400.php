        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-6">
                                    <div class="small-box bg-gradient-purple">
                                        ...
                                        <a href="<?=base_url();?>Cuti/view_admin/semua" class="small-box-footer">Detail <i
                                ...
                                <div class="col-lg-6 col-6">
                                    <div class="small-box bg-gradient-teal">
                                        ...
                                        <a href="<?=base_url();?>Pegawai/view_admin" class="small-box-footer">Detail <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="small-box bg-gradient-blue">
                                        ...
                                        <a href="<?=base_url();?>Cuti/view_admin/diterima" class="small-box-footer">Detail <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-6">
                                    <div class="small-box bg-gradient-red">
                                        ...
                                        <a href="<?=base_url();?>Cuti/view_admin/ditolak" class="small-box-footer">Detail <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-6">
                                    <div class="small-box bg-gradient-orange">
                                        ...
                                        <a href="<?=base_url();?>Cuti/view_admin/menunggu" class="small-box-footer">Detail <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Baris tambahan untuk detail per level pengguna -->
                    <div class="row">
