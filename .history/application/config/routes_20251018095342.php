...
// Route untuk pegawai - form cuti
$route['pegawai/permohonan-cuti'] = 'Form_Cuti/add_cuti';
$route['pegawai/ajukan-cuti'] = 'Form_Cuti/add_cuti';
$route['form-cuti'] = 'Form_Cuti/add_cuti';
$route['proses-cuti'] = 'Form_Cuti/proses_cuti';
