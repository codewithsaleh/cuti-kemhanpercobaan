...
UPDATE `user` SET `password` = '9c8c4a7b0c7c1e3d4b6a8e5d9c7b1a' WHERE `username` = '99.111.005';
UPDATE `user` SET `password` = '9c8c4a7b0c7c1e3d4b6a8e5d9c7b1a' WHERE `username` = '99.111.006';

-- PERBAIKAN FINAL: Gunakan MD5 yang benar
UPDATE `user` SET `password` = MD5('kemhan2025');
